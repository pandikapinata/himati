			...
			<div class="card-body">
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input id="judul_berita" type="text" class="form-control" name="judul_berita" value="{{ $news->judul_berita }}" required>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group">
                        <label>Content</label>
                        <textarea id="deskripsi" class="form-control" rows="5" name="content" required>{{ $news->isi_berita }}</textarea>
                        <script>
