...
<div class="spacer">
    <div class="container">
        ...
        <div class="col-lg-9 p-r-30">
                ...
                {{-- <img src="{{ URL::asset('assets/images/berita/' . $news->foto_berita) }}" alt="hmti" class="img-fluid" /> --}}
            ...
            <div class="m-b-40">
                ...
                <div class="row blog-row m-t-20 no-gutter b-b p-b-10 no-block">
                    <div class="col-md-4 no-gutter">
                        <a href="{{ route('berita.show', $new ) }}"><img src="{{ URL::asset('assets/images/berita/' . $new->foto_berita) }}" alt="hmti" class="img-responsive" /></a>
                    </div>
