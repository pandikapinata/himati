                        ...
                        <div class="col-lg-9 p-r-30">
                            ...
                            @foreach($news as $number => $new)
                                <div class="row list-berita d-flex b-b p-b-10 m-t-10 m-b-20 no-block no-gutter">
                                    <div class="col-md-3"><img src="assets/images/berita/{{$new->foto_berita}}" alt="wrapkit" class="img-responsive" style="width:auto; height:auto; max-height:200px; max-width:200px"></div>
                            ...
                            <div class="m-b-40">
                                ...
                                <div class="row blog-row m-t-20 no-gutter b-b p-b-10 no-block">
                                    <div class="col-md-4 no-gutter">
                                        <a href="{{ route('berita.show', $new ) }}"><img src="assets/images/berita/{{$new->foto_berita}}" alt="wrapkit" class="img-responsive" /></a>
                                    </div>
